...
def main():
    ...
    classsification, transformed_anchors = model.module(dummy_input)
    ...
    print('classification.shape = {}'.format(str(classsification.shape)))
    print('transformed_anchors.shape = {}'.format(str(transformed_anchors.shape)))
