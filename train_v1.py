...
def get_logger(name='My Logger', args=None):
    ...
    if args is not None and args.log:
        filehandler = logging.FileHandler(os.path.join('log', '{}_{}.log'.format(args.dataset, args.architecture)), mode='a')
...
def main():
    ...
    if args.architecture == 'RetinaNet':
        ...
        net_model = efficientdet.build_efficientdet(args.architecture, num_classes=dataset_train.num_classes(), **build_param)
