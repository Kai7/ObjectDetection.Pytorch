...
class ShuffleNetV2(nn.Module):
    def __init__(self, stages_repeats, stages_out_channels, num_classes=1000, inverted_residual=InvertedResidual, **kwargs):
        ...
        self.feature_maps_channels = stages_out_channels[-4:-1]
